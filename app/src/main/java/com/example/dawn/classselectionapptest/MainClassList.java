package com.example.dawn.classselectionapptest;
...
import static com.example.dawn.classselectionapptest.R.id.swDegreeCert;
...
public class MainClassList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch swDegreeCert = (Switch) findViewById(swDegreeCert);
